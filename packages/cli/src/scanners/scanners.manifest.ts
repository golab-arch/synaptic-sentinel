/**
 * Pinned versions and SHA-256 checksums (GitHub Releases API) of the OSS
 * scanners that the Scout Layer runs. `archive` marks compressed assets
 * (zip / tar.gz) that need extracting; absent = loose binary. `archiveDir`
 * is a subdirectory inside the archive where the binary lives (flattened
 * after extraction).
 *
 * Single source of truth (DG-059): both the CLI's `scanners install`
 * sub-command and the scout integration tests (which need to find where a
 * scanner was installed) import this typed const.
 *
 * To bump a scanner: update its `version` and the per-platform `sha256`.
 *
 * License: Apache-2.0 (OSS).
 */
import type { ScannersManifest } from './install.js';

export const SCANNERS_MANIFEST: ScannersManifest = {
  installDir: '.scanners',
  scanners: {
    opengrep: {
      version: 'v1.22.0',
      ...
      platforms: {
        ...
        'darwin-x64': {
          ...
          sha256: 'e9733c7ac4ad16ac5bbbcbff0264478c7b524d6750f29c847f93aacee3315d2b',
          binary: 'opengrep',
        },
        'darwin-arm64': {
          asset: 'opengrep_osx_arm64',
          sha256: '6105ab78eca041fcb9f83055939088ba8f96a6cb66683ceced39652938b217ce',
          binary: 'opengrep',
        },
        'linux-x64': {
        ...
        'linux-arm64': {
          ...
          sha256: '8df71670e20336646687c6f4ddf9b4532f1a7fcd8a8ea7bfa4ea46747f61e088',
          binary: 'opengrep',
        },
      },
    },
    ...
    checkov: {
      ...
      platforms: {
        'win32-x64': {
          asset: 'checkov_windows_X86_64.zip',
          sha256: '992095a9db88078b088b6dc74b123e6be9b1d98c18c201e68d90c00fae628cd7',
          archive: 'zip',
          binary: 'checkov.exe',
        },
        'darwin-x64': {
          asset: 'checkov_darwin_X86_64.zip',
          sha256: 'e9b1f27e297f029dc52295d940c94225dc333252b21ae05f86a6bd7ab8599d85',
          archive: 'zip',
          binary: 'checkov',
        },
        'linux-x64': {
          asset: 'checkov_linux_X86_64.zip',
          sha256: '84b837a42d647711d066b7acf89e6ccadbb15b3977a6f7cde552d860faec01b7',
          archive: 'zip',
          binary: 'checkov',
        },
        'linux-arm64': {
          asset: 'checkov_linux_arm64.zip',
